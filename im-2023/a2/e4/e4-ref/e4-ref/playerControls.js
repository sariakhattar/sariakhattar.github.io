...
function muteUnmute(){
  ...
  if(videoElement.muted){
    ...
    muteButton.style.background = "url('./icons/mute.svg')";
} else {
    videoElement.muted = true;
    muteButton.style.background = "url('./icons/unmute.svg')";
}
}

muteButton.addEventListener("click", muteUnmute);

/* I chose this extra feature is imporant to add as it helps the users control the screen and see better.
I think it inhances the experince as it gets rid of distractions around it and can help the viewer obtain full 
attention on the experince and video they are watchng. Usability becomes more easier accessible as you have the 
choice to incrase or decrease the screen according to their needs. */
